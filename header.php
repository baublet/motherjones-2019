    ...
    <header id="header" role="banner">
        <div class="px-0 relative z-50">
            ...
            <div class="navigation">
                ...
                <label for="headerNav" class="cursor-pointer p-sm block desktop:hidden bg-primaryDark text-primaryText toggleChecked:bg-foreground toggleChecked:text-background flex justify-between items-center hover:bg-foreground">
